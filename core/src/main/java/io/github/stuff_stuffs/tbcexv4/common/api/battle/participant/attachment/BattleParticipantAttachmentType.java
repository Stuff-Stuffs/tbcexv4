...
public final class BattleParticipantAttachmentType<V, T extends BattleParticipantAttachment> {
    ...
    public BattleParticipantAttachmentType(final BiFunction<BattleParticipantView, T, Text> name, final BiPredicate<BattleParticipantView, T> visible, final Function<T, ? extends V> viewExtractor) {
        this.name = name;
